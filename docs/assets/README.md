...
3. Two actual app captures: a real tissue-side crop with demonstration retained-piece outlines and dashed scoring lines, followed by those same pieces (1–2) multiplexed with 11 additional demonstration tissue polygons on a recipient slide. The outlines and placements are illustrative, not an actual experiment plan.
